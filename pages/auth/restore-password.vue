  ...
  <div class="restore-password">
    ...
    <div class="restore-password__window" @keyup.enter="enterHandle">
      ...
      <div class="restore-password__actions">
        ...
        <base-button v-if="step !== 3" variant="next" :class="{disabled: !canNextStep}" @click="nextStep">Продолжить</base-button>
        <base-button v-if="step === 3" variant="next" :class="{disabled: !canNextStep}" @click="savePassword">Сохранить и войти</base-button>
      </div>
