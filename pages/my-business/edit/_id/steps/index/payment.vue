          ...
          <div class="payment__input-box">
            <div class="payment__input-title">Выберите страну/территорию, где находится получатель счетов</div>
              <base-select
                :options="countries"
                label="name"
                v-model="form.payment.country_name"
              />
<!--            <base-input-->
<!--              class="payment__input"-->
<!--              placeholder="Введите название"-->
<!--            />-->
          ...
          <div class="payment__input-box">
            ...
            <base-select
              :options="cities"
              label="name"
              v-model="form.payment.city_name"
            />
<!--            <base-input-->
<!--              class="payment__input"-->
<!--              placeholder="Укажите город"-->
<!--              v-model="form.payment.city"-->
<!--            />-->
          </div>
          ...
          <div class="payment__input-box">
            ...
            <base-input
              ...
              v-model="form.payment.post_index"
            />
          </div>
        </div>
        </slide>
...
export default {
  ...
  validations: {
    form: {
      is_address: {required},
      payment: {
        city: {required: requiredIf(function (){return !this.form.is_address})},
        city_name: {required: requiredIf(function (){return !this.form.is_address})},
        country: {required: requiredIf(function (){return !this.form.is_address})},
        country_name: {required: requiredIf(function (){return !this.form.is_address})},
        address: {required: requiredIf(function (){return !this.form.is_address})},
        post_index: {required: requiredIf(function (){return !this.form.is_address}), maxLength: maxLength(20)},
      }
    }
  },
  computed: {
